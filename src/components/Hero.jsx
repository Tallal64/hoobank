...
const Hero = () => {
  return (
    <section
      id="home"
      className={`flex flex-col md:flex-row ${styles.paddingY} mb-10`}
    >
      {/* TEXT-CONTAINER */}
      <div
        className={`flex flex-1 flex-col justify-center  md:mb-28 -mb-14 px-4 sm:px-16 xl:px-0`}
      >
        {/* DISCOUNT */}
        ...
        <p className="text-center sm:text-start text-dimWhite max-w-md my-8 text-base md:text-lg font-poppins mt-5">
          Our team of experts use a metalogy to identify the credit cards to
          most likely to fit your needs.We examins annual percent rates and
          percent fees.
        </p>
      </div>
