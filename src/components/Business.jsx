...
const Business = () => {
    return (
        <section id="features" className='flex flex-col md:flex-row py-6 sm:py-16 font-poppins'>
            ...
            <div className="mt-14">
                ...
                <div className="flex justify-start mt-3 feature-card rounded-lg py-3 px-4">
                    <div className="bg-dimBlue w-16 h-16 rounded-full flex justify-center items-center">
                        <img src={star} alt="star" className="w-1/2 h-1/2 object-contain " />
                    </div>

                    <div className="flex flex-1 flex-col justify-start ml-3">
                        <h4 className="font-semibold text-lg">Rewards</h4>
                        <p className="max-w-md text-dimWhite text-base">The best credit cards offer some tantalizing combinations of promotions and prizes</p>
                    </div>
                </div>
                ...
                <div className="flex justify-start mt-3 feature-card rounded-lg py-3 px-4">
                    <div className="bg-dimBlue w-16 h-16 rounded-full flex justify-center items-center">
                        <img src={shield} alt="star" className="w-1/2 h-1/2 object-contain " />
                    </div>

                    <div className="flex flex-1 flex-col justify-start ml-3">
                        <h4 className="font-semibold text-lg">100% Secured</h4>
                        <p className="max-w-md text-dimWhite text-base">We take proactive steps make sure your information and transactions are secure.</p>
                    </div>
                </div>
                ...
                <div className="flex justify-start mt-3 feature-card rounded-lg py-3 px-4">
                    <div className="bg-dimBlue w-16 h-16 rounded-full flex justify-center items-center">
                        <img src={send} alt="star" className="w-1/2 h-1/2 object-contain " />
                    </div>

                    <div className="flex flex-1 flex-col justify-start ml-3">
                        <h4 className="font-semibold text-lg">Balance Transfer</h4>
                        <p className="max-w-md text-dimWhite text-base">A balance transfer credit card can save you a lot of money in interest charges.</p>
                    </div>
                </div>
            </div>
        </section>
