...
const Billing = () => {
    return (
        <section id='product' className='flex flex-col-reverse md:flex-row md:gap-x-20 gap-x-0 sm:mt-20 mt-14 gap-y-10'>
            {/* IMAGE-SECTION */}
            ...
            <div className='flex flex-col flex-1 justify-center items-start'>
                ...
                <div className='flex gap-x-5 flex-row flex-wrap'>
                    <img src={google} alt="google" className='object-contain w-36 h-11 cursor-pointer' />
                    <img src={apple} alt="apple" className='object-contain w-36 h-11 cursor-pointer' />
                </div>
            </div>
        </section>
    )
